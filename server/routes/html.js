...
module.exports = () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//cdn.auth0.com/extensions/auth0-logs-to-stackify/assets/auth0-logs-to-stackify.ui.<%= assets.version %>.css" /><% } %>
  ...
  <body>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//cdn.auth0.com/extensions/auth0-logs-to-stackify/assets/auth0-logs-to-stackify.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//cdn.auth0.com/extensions/auth0-logs-to-stackify/assets/auth0-logs-to-stackify.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
